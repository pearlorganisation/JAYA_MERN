    ...
    return (
        <>
            ...
            <button
                ...
                type="button"
                className={`visible mt-12 lg:mt-0 bg-red-500 top-6 left-0 z-40 order-10 block w-full rounded  opacity-100 lg:hidden ${isSideNavOpen
            ...
            <aside
                id="nav-menu-1"
                aria-label="Side navigation"
                className={`fixed top-0 bottom-0 left-0 z-40 flex flex-col border-r w-[18%] border-r-slate-200 bg-white transition-transform lg:translate-x-0 ${isSideNavOpen ? "translate-x-0" : " -translate-x-full"
                    }`}
            >
                <Link
                    to="/"
