    ...
    <div className=" w-full grid place-items-center px-4 md:py-10 md:px-16">
      ...
      <div className="bg-white px-6 rounded-lg  mt-16 ">
        ...
        <div className="border-2 border-green-100 px-6 rounded-lg mt-8">
          ...
          <p className="text-[#5e5e5e] mb-6 lg:w-[70%] text-base pb-8">
      ...
      <div className="max-w-6xl mx-auto grid place-items-center w-[80%] mb-8 mt-16">
        <div className="flex flex-row" data-aos="zoom-in">
          ...
          <h1 className="text-[34px] lg:text-[85px]  text-[#668DCB] text-nowrap font-extrabold mt-10  lg:mt-16 lg:ml-4">
            Our Mission
          </h1>
          <img
            src="mission.png"
            className="w-12 h-14 block lg:hidden -translate-x-4 translate-y-7 lg:-translate-x-10 lg:translate-y-5"
          />
          <img
            src="mission.png"
            className="hidden lg:block lg:w-30 lg:h-40 -translate-x-4 translate-y-7 lg:-translate-x-10 lg:translate-y-5"
          />

          <h1 className="block text-[60px] -translate-y-0 -translate-x-4 md:hidden">
            ❜❜
          </h1>

          <h1 className="hidden md:block lg:text-[120px] text-[#1F3456] font-bold  md:-translate-y-0 md:-translate-x-10 ">
            ❜❜
          </h1>
        </div>
