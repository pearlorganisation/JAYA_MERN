...
const Schemes = () => {
  ...
  const schemesState = useSelector((state) => state.schemes.schemes.data);
  ...
  console.log("Schemes State", schemesState);
  return (
    <div>
