...
const SchemeCard = ({ scheme }) => {
  ...
  function addBookmark(schemeId) {
    dispatch(addSchemeToBookmark({ userId: userData?.user?._id, schemeId }));
  }
  function removeBookmark(schemeId) {
    dispatch(removeFromBookmark({ userId: userData?.user?._id, schemeId }));
  }
  return (
    <div
      key={scheme._id}
