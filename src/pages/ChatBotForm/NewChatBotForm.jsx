                    ...
                    <div className="relative ml-3 text-sm bg-white py-2 px-4">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full p-2 mt-1 border-2 border-green-100 rounded-lg"
                          placeholder=" _ _ _ "
                        />
                      </div>
                    </div>
                    ...
                    <div className="relative ml-3 text-sm bg-white py-2 px-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-6 py-2 mt-1 border-2 border-green-100 rounded min-w-48"
                        >
                          <option value="" className="mb-4">
                            Select your state{" "}
                          </option>
                          {[
                            "Tamil Nadu",
