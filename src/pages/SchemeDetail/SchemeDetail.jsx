      ...
      <div className="p-4 md:p-8">
        <div className="bg-white rounded-lg space-y-3 shadow-md p-6 border border-gray-200">
          <div className="flex justify-between items-start mb-4">
            <p className="text-[#393939] text-base font-light">
          ...
          <div className="flex justify-between items-center ">
            <div className="flex flex-wrap items-center gap-2 ">
              <span className="border-[#B6D8C2] border text-[#419A62] text-xs font-normal px-2 py-1 rounded-md">
                1000/month
              </span>
              <span className="border-[#B6D8C2] border text-[#419A62] text-xs font-normal px-2 py-1 rounded-md">
                70% Reservation
            ...
            <div className="flex justify-between items-center w-fit">
              <Link to="/schemeDetail">
                <button className="text-white hover:bg-white bg-[#419A62] hover:text-[#419A62] text-base font-medium border border-green-100 px-6 py-2 rounded">
                  Check Eligibility
                </button>
              </Link>
            </div>
