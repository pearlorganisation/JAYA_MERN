                  ...
                  
                    {
                     DummyData.map((el,index)=>{
                            return(
                                ...
                                <td className="px-6">
                                    <div className='flex  gap-4 items-start  font-bold text-md flex-col '>
                                        <Link  to= {"viewScheme"} className='text-blue-500  hover:text-blue-600'>View</Link>
                                        <Link  to= {"editScheme"} className='text-green-500 hover:text-green-600'>Edit</Link>
                                        <Link  to= {"deleteScheme"} className='text-red-500 hover:text-red-600'>Delete</Link>
                                    </div>
                                </td>
                            </tr>
                            )
