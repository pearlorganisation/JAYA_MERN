    ...
    <div>
      ...
      <table className="min-w-full divide-y divide-gray-200">
        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {
           Array.isArray( schemes?.data) &&  schemes?.data?.length > 0 && schemes?.data?.map(item =>{
            return  <tr className="bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-shadow duration-300">
...
<tr className="bg-white dark:bg-gray-800 shadow-md hover:shadow-lg transition-shadow duration-300">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-0 z-50">
          <Modal schemeData={scheme} isOpen={isModalOpen} onClose={closeModal}/>
